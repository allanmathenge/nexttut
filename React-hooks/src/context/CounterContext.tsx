...
const useCounterContext = (initState: StateType) => {
    ...
    const handleTextInput = useCallback((e: ChangeEvent<HTMLInputElement>) => (dispatch({ type: REDUCER_ACTION_TYPE.TEXT_INPUT, payload: e.target.value})), [])
...
export const CounterContext = createContext(initContextState)
